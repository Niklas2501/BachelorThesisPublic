...
class Configuration:
    ...
    def __init__(self, dataset_to_import=0):
        ...
        # test interferences the full test datasets and calculates accuracy
        self.inference_type = 'test'

        # functionality currently disabled but should be working
        # continue Training the model from the file configured below
        # be sure the same hyper parameters are used, this is not tested/checked
        ...
        self.preprocessed_folder = '../data/preprocessed_data_combined/'
