...
def main():
    ...
    # save the np arrays
    print('\nSave to np arrays in ' + config.preprocessed_folder)

    print('Step 1/4')
    np.save(config.preprocessed_folder + 'train_features.npy', x_train)
    print('Step 2/4')
    np.save(config.preprocessed_folder + 'test_features.npy', x_test)
    print('Step 3/4')
    np.save(config.preprocessed_folder + 'train_labels.npy', y_train)
    print('Step 4/4')
    np.save(config.preprocessed_folder + 'test_labels.npy', y_test)
